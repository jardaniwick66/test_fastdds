...
/*!
 * @file testmsgTypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_TestMsg)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_TestMsg)
    {
        ...
        CompleteStructMemberSeq member_seq_TestMsg;
        {
            ...
            CompleteMemberDetail detail_index = TypeObjectUtils::build_complete_member_detail(name_index, member_ann_builtin_index, ann_custom_TestMsg);
            CompleteStructMember member_index = TypeObjectUtils::build_complete_struct_member(common_index, detail_index);
            TypeObjectUtils::add_complete_struct_member(member_seq_TestMsg, member_index);
        }
        {
            ...
            ann_custom_TestMsg.reset();
            CompleteMemberDetail detail_message = TypeObjectUtils::build_complete_member_detail(name_message, member_ann_builtin_message, ann_custom_TestMsg);
            CompleteStructMember member_message = TypeObjectUtils::build_complete_struct_member(common_message, detail_message);
            TypeObjectUtils::add_complete_struct_member(member_seq_TestMsg, member_message);
        }
